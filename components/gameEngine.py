"""Core game engine that owns context, systems, and managers."""
__author__ = "Miro K."
...
from components.managers import PlantManager, ProjectileManager, ZombieManager
from components.systems import CombatSystem, ShootingSystem, SpawnSystem, SunSystem
